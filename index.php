    ...
    <body>
        ...
        <div class='bodyimage'>
            <div class='textinimage'>
                <h1>Bienvenue dans Bookexchange Programme</h1>
                <h4>Votre espace online pour trouver, partager et échanger des livres</h4>
                <div class='container'>
                    <div class="row">
                        <div class='col-6'>
                    ...
                    <div class='row'>
                        <div class='col-12'>
                            <a class='passwordresetlink' href="index.html">Forget your password?</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class='websitedef'>
            <div class='title'>Booxchange Programme</div>
            <div class='bookswap'>
                <img class='bookswapimage'  src="assest/img/Bookswap.jpg">
            </div>
            
            
            <div class='def'>
                <p><p1 class='subtitle'>Qu'est-ce que Bookxchange?</p1></p>
                
                    <p><p2>&nbsp;&nbsp;&nbsp;  Il s'agit d'une plate-forme électronique dédiée aux amateurs de lecture qui facilite le processus de partage et d'échange de livres de l'utilisateur, ainsi que de faire connaissance avec des personnes partageant la même passion.</p2></p>
                
                <p><p1 class='subtitle'>Comment l'utiliser?</p1></p>
                
                    <p><p2>&nbsp;&nbsp;&nbsp; Notre plateforme est simple d'utilisation, Tout ce que vous avez à faire est en seulement 3 étapes: Créez un compte, connectez-vous, et parcourez vos livres préférés</p2></p>
            ...
            <div class="row p-1">
                <div class=' col-md-12 col-sm-4 col-lg-4 col-xs-12 my-footer-col'>
                    ...
                    <div class='footer-description'>
                        <h5>BOOXCHANGE</h5>
                        <p>Votre espace online pour trouver, partager et échanger des livres</p>
                    </div>
                </div>
                <div class=' col-md-12 col-sm-4 col-lg-4 col-xs-12 my-footer-col'> 
                    Get Srarted
                    ...
                    <div class='footer-description'>
                        ...
                        <button class="footer-reg-btn" href="#" >Inscrivez-vous</button>
                ...
                <div class='col-md-12 col-sm-4 col-lg-4 col-xs-12 my-footer-col'>
                    ...
                    <div class='footer-description'>
                        ...
                        <div class='my-footer-icons' >
                            ...
                            </svg>&nbsp;&nbsp;&nbsp; <a class='text-light' href="https://facebook.com" >Instagram</a>
                        </div>
                    </div>
                </div>
            </div>
